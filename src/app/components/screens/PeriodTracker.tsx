  ...
  return (
    <div className="min-h-screen bg-[#E7DDFF] p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2" style={{ color: '#594F62' }}>Period Tracker</h1>
          <p style={{ color: '#776B7D' }}>Track your menstrual cycle and get personalized predictions</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <Card className="p-6 bg-white">
              <h3 className="text-lg font-semibold mb-4" style={{ color: '#594F62' }}>Mark Your Period Days</h3>
  ...
  {range?.from && range?.to
    ...
    : "Select the start and end date of your period."}
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-white">
              <h3 className="text-lg font-semibold mb-4" style={{ color: '#594F62' }}>Cycle Settings</h3>
            ...
            <Card className="p-4 border" style={{ backgroundColor: '#D4C4EC', borderColor: '#B2A0B9' }}>
              <h3 className="text-lg font-semibold mb-3" style={{ color: '#594F62' }}>Tracking Tips</h3>
